...
class SVMAssembler(Assembler):
    def __init__(self, kernel, gamma, class_weight):
    ...
    def assemble(self, data: Dict[str, dict], fl_ctx: FLContext) -> DXO:
        ...
        if current_round == 0:
            ...
            svm_global = SVC(kernel=self.kernel, gamma=self.gamma, class_weight=self.class_weight)
